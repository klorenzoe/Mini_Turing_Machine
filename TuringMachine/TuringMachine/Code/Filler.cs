...
namespace TuringMachine.Code
{
    public static class Filler
    {
        ...
        public static List<State> unaryMinusAutomata { get; set; }
        ...
        public static void fillAutomatas() {
            if (!AreTheAutomatasFilled)
            {
                ...
                unaryMinusAutomata = fillUnaryMinusStatus();
        ...
        private static List<State> fillPalindromesStatus()
        {
            ...
            var q1 = new State()
            {
                ...
                possibleTransitions = new List<Transition>()
                {
                    ...
                    new Transition() { currentSymbol = "c", transitionState="q1", transitionSymbol="c", movement="R"},
        ...
        private static List<State> fillUnaryMinusStatus()
        {
            //q0
            var q0 = new State()
            {
